     ...
     <div class="container mt-5">
          <div class="row">
               ...
               <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="horaInicio" placeholder="horaInicio">
                                    <input type="text" class="form-control mb-3" name="horaSalida" placeholder="horaSalida">
